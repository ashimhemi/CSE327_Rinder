...
public class Registration extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            nameRegister = findViewById(R.id.tutorName);
            emailRegister = findViewById(R.id.tutorEmail);
            passwordRegister = findViewById(R.id.universityName);
            gender=findViewById(R.id.tutorGender);
            subject=findViewById(R.id.tutorSubject);
